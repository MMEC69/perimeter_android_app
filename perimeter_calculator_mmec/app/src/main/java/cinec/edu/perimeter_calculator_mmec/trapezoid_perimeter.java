...
public class trapezoid_perimeter extends AppCompatActivity {

    EditText edge1, edge2, edge3, edge4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trapezoid_perimeter);
        ...
        answerProceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                double input4 = Double.parseDouble(edge4.getText().toString());
